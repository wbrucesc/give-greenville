    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests()
                    ...
                    .antMatchers("/myPosts", "/edit/**").hasRole("USER")
                    .antMatchers("/consider/**", "/create", "/createAsk", "/createGive", "/createFlash").hasAnyRole("ADMIN", "USER", "MODERATOR")
                    .antMatchers("/flagged").hasAnyRole("ADMIN", "MODERATOR")
                    .and()
                .formLogin()
                    .loginPage("/login")
